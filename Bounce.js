...
Bounce.prototype.error = function (message) {
  if (this.alert_errors) alert(message);
  if (this.log_info) console.log(message);
};

Bounce.prototype.log = function (message) {
  if (this.log_info) console.log(message);
};

Bounce.prototype.set_viewport = function (x, y) {
  this.viewport.x = x;
  this.viewport.y = y;
};

Bounce.prototype.keydown = function (e) {
  var _this = this;
...
Bounce.prototype.keyup = function (e) {
  var _this = this;
...
Bounce.prototype.load_map = function (map) {
  if (
...
Bounce.prototype.get_tile = function (x, y) {
  return this.current_map.data[y] && this.current_map.data[y][x]
    ? this.current_map.data[y][x]
    : 0;
};

Bounce.prototype.draw_tile = function (x, y, tile, context) {
...
Bounce.prototype.draw_map = function (context, fore) {
...
Bounce.prototype.move_player = function () {
...
Bounce.prototype.draw_player = function (context) {
...
Bounce.prototype.draw = function (context) {
